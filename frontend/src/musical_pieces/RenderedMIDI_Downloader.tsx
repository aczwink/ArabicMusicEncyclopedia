...
@Injectable
export class RenderedMIDI_Downloader extends Component<{ pieceId: string; }>
{
    ...
    public OnInitiated()
    {
        this.dialogRef.onAccept.Subscribe(() => {
            const url = g_backendBaseUrl + "/musicalpieces/" + this.input.pieceId + "/midi?basePitch=" + OctavePitchToString(this.selectedPitch);
